...
data class ChatMessage(
    ...
    /** Optional caption for image/video/file messages. */
    val caption: String? = null,
    /** Comma-separated amplitudes (0..1) for voice note waveform display. */
...
class VirtualChatMessageAdapter(
    ...
    companion object {
        ...
        /** Parse comma-separated amplitudes (0..1) from waveformData string. */
