  ...
  private final CameraSession.Events cameraSessionEventsHandler = new CameraSession.Events() {
    ...
    public void onCameraError(CameraSession session, String error) {
      ...
      synchronized (stateLock) {
        ...
        Intent cameraErrorBroadcast = new Intent("sdk_broadcast_custom");
        cameraErrorBroadcast.putExtra("task", "camera_device_update");
        applicationContext.sendBroadcast(cameraErrorBroadcast);
      }
    }
